/*
 * datawrapper / vis / d3-bars-stacked v0.6.1
 * generated on 2016-02-22T06:25:23+01:00
 */
/*! datawrapper - v1.10.2 */
...
if(colorKey){var swatches=[];_.each(colorKey,function(key,id){key.id=id;if(colorKeyByColumn){key.color=vis.autocolor(vis.colorKeys().indexOf(id),id,theme);}
